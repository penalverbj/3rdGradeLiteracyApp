    ...
    <>
      <SafeAreaView style={styles.startContainer}>
        ...
        <ScrollView style={styles.scrollView}>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#fcf351'}]}>
            <Text style={styles.section}>12: synonyms</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#f3b2c8'}]}>
            <Text style={styles.section}>13: antonyms</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#bfe54e'}]}>
            <Text style={styles.section}>14: homophones</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#e0696b'}]}>
            <Text style={styles.section}>15: puns</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '##cda1d2'}]}>
            <Text style={styles.section}>16: homographs</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#f3b88c'}]}>
            <Text style={styles.section}>17: similies & metaphors</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#c3c3c3'}]}>
            <Text style={styles.section}>18: onomatopeia</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#fdf885'}]}>
            <Text style={styles.section}>19: irony or sarcasm</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#a7d8e8'}]}>
            <Text style={styles.section}>20: personification</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#f6cb47'}]}>
            <Text style={styles.section}>21: hyperbole</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#ddc0e1'}]}>
            <Text style={styles.section}>22: euphemism</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#b87cbe'}]}>
            <Text style={styles.section}>23: oxymoron</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#66cf69'}]}>
            <Text style={styles.section}>24: rhyme</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.lesson, {backgroundColor: '#ee7af8'}]}>
