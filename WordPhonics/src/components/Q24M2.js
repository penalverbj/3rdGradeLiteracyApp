...
var incorrectPairs =
  [
    ...
    ["high", "my", "eye"],
    ["shoe", "do", "blue"],
    ["baloon", "racoon", "teaspoon"],
    ["calf", "laugh", "half"],
    ["strawberry", "fairy", "carry"],
    ["excavator", "educator", "refrigerator"]
  ];

export default function Q24M2({navigation}) {
    ...
    // quiz screen
    const title = "Words rhyme when their last vowel sound is the same, and any sound after the vowel is the same. The letters that spell the words don't have to be the same, just the sounds.";
    React.useEffect(() => {
    ...
    const generateQuestion = () => {
      ...
      var filler = incorrectPairs[index];
        ...
        <SafeAreaView style={styles.subContainer}>
          ...
          <TouchableOpacity onPress = {() => {
              ...
              <Text style={styles.question}>
                Which word does NOT rhyme with {question}
              </Text>
          </TouchableOpacity>
            <TouchableOpacity onPress = {() => {
